        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <p className="text-muted-foreground text-lg leading-relaxed">
              Isaac Tomz Services Ltd is a premier architectural design and construction
              firm committed to delivering exceptional quality across Nigeria.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              From bespoke residential designs to large-scale commercial projects, our
              team of skilled professionals brings decades of combined experience to every
              project. We don't just build structures — we craft legacies.
            </p>
            <motion.blockquote
              whileHover={{ x: 5 }}
