          ...
          <div className="container-luxury">
            ...
            >
              ...
              <p className="text-warm-concrete text-lg md:text-xl max-w-2xl leading-relaxed">
                A premier architectural design and construction firm building 
                Nigeria's future with precision, integrity, and excellence.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-16">
              ...
              >
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  ...
                  <p>
                    We believe that every project, regardless of scale, deserves the same level 
                    of attention to detail and commitment to excellence. This philosophy has 
                    earned us the trust of homeowners, property developers, and corporate clients 
                    across Nigeria.
                  </p>
                </div>
              </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed">
                  To deliver premium architectural design and construction services that 
                  transform our clients' visions into enduring realities, while maintaining 
                  the highest standards of professionalism, transparency, and craftsmanship.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed">
                  To be recognized as Nigeria's foremost architectural and construction 
                  firm, setting new benchmarks for quality, innovation, and client 
